...
ICP_3ARG = re.compile(r'[ \t]*(fp|fpt)[ \t]*[,=]?[ \t]*'+INT_REGEXP + SEP + FP_REGEXP + SEP + FP_REGEXP + r'[ \t]*$', re.IGNORECASE)   
ICP_4ARG = re.compile(r'^[ \t]*(fp|fpt|iscan)[ \t]*[,=]?[ \t]*'+INT_REGEXP + SEP + FP_REGEXP + SEP + FP_REGEXP + SEP + FP_REGEXP + r'[ \t]*$', re.IGNORECASE)
