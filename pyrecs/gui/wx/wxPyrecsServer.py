...
# spinctrl.py
import sys
sys.path.append('/home/bbm/pydev')
import wx
import os
...
from pyrecs.InstrumentController import InstrumentController
...
class MyDialog(wx.Dialog):
    def __init__(self, parent, id, title, ic):
    ...
    def GetNMR(self, event = None):
        result = self.he3ctrl.GetNMR()
        self.ResultText.SetLabel(result)
        self.ResultText.Wrap(350)  

    def Flip(self, event = None):
        result = self.he3ctrl.Flip()
        self.ResultText.SetLabel(result)  
        self.ResultText.Wrap(350)  
                
    def TestConnection(self, event = None):
        result = self.he3ctrl.TestConnection()
        self.ResultText.SetLabel(result)
        self.ResultText.Wrap(350)
...
class MyApp(wx.App):
    def OnInit(self):
        ...
        dlg = MyDialog(None, -1, 'PyReCS Server', ic)
